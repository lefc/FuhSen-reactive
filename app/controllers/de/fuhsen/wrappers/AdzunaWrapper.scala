...
/**
  ...
  */
class AdzunaWrapper extends RestApiWrapperTrait with SilkTransformableTrait {
  ...
  override def apiUrl: String = ConfigFactory.load.getString("adzuna.search.url")

  /**
    * Returns the globally unique URI String of the source that is wrapped. This is used to track provenance.
    */
  override def sourceLocalName: String = "adzuna"
